...
// Start session if not already started (handled by functions.php)
// session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<nav class="navbar navbar-expand-lg navbar-custom">
    <div class="container-fluid">
        ...
        <!-- Navbar Content (Links, Search, Auth, Cart) -->
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <form class="d-flex me-3" role="search" action="<?php echo BASE_URL; ?>search.php" method="GET">
                <input class="form-control" type="search" name="q" placeholder="Search by dress name" aria-label="Search">
                <button class="btn btn-outline-success" type="submit"><i class="fas fa-search"></i></button>
            </form>
            
            <!-- User Greeting / Login & Cart Icons -->
            <div class="d-flex align-items-center">
                ...
                <?php else: ?>
                    <a href="<?php echo BASE_URL; ?>login.php" class="nav-link login-signup">Login/Signup</a>
                <?php endif; ?>
